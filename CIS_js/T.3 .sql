...
SELECT
  ...
  CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('1110') AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN CIS2.NVAL(D.COL4) ELSE NULL END))||'~'||R.NR_ROW AS NR_ROW,
  ...
  ROUND(CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('1110') AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN CIS2.NVAL(D.COL5) ELSE NULL END)),2) AS COL1
