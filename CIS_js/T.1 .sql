...
SELECT
  ...
  CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('1000') AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN CIS2.NVAL(D.COL4) ELSE NULL END))||'~'||R.NR_ROW AS NR_ROW,
  TO_NUMBER(R.NR_ROW) AS ORDINE,
  '1111' AS DECIMAL_POS,
  
  R.NUME_ROW AS NUME_ROW,
  
--  CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('010') AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN CIS2.NVAL(D.COL3) ELSE NULL END)) AS COL1,
  CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('1000') AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN CIS2.NVAL(D.COL5) ELSE NULL END)) AS COL1,
  CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('1000') AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN CIS2.NVAL(D.COL6) ELSE NULL END)) AS COL2,
  CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('1000') AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN CIS2.NVAL(D.COL7) ELSE NULL END)) AS COL3,
  CIS2.NVAL(SUM(CASE WHEN D.RIND IN ('1000') AND CC.FULL_CODE LIKE '%'||R.CS_CUATM||'%' THEN CIS2.NVAL(D.COL8) ELSE NULL END)) AS COL4
